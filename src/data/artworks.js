...
export const ARTWORKS = [
  ...
  },
  {
    ...
    image: "/artworks/quilted-geometry.jpg",
    imageCredit: "Stand-in image: Ella Maria Deacon, \"Friendship Quilt,\" 1842 — Art Institute of Chicago, public domain",
  ...
  {
    id: "painted-parrot",
    title: "Painted Parrot",
    artist: "Theo Marsh",
    year: 2011,
    decade: "2010s",
    medium: "Carved and painted wood",
    palette: ["#3f8f5c", "#d94f30", "#f2c14e"],
    image: "/artworks/painted-parrot.jpg",
    imageCredit: "Stand-in image: Wilhelm Schimmel, \"Parrot,\" 1870–90 — Art Institute of Chicago, public domain",
    blurb: "A bright, hand-carved parrot perched mid-call, painted in bold folk-art colors.",
    themes: ["folk art", "animals", "color"],
    onView: true,
    gallery: "Demo Gallery B",
    exhibition: "Prototype Collection",
    lastVerified: "2026-08-28",
    sources: [
      {
        label: "Demo collection record",
        url: "https://example.org/demo/painted-parrot",
        excerpt: "Hand-carved and painted by a self-taught folk artist known for lively animal figures made from reclaimed wood.",
      },
    ],
  },
  {
    ...
    image: "/artworks/prairie-night.jpg",
    imageCredit: "Stand-in image: George Inness, \"Moonrise,\" 1891 — Art Institute of Chicago, public domain",
