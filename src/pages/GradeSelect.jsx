...
export default function GradeSelect() {
  ...
  // One choice total across all three groups. Selecting an option only
  // records the preference and highlights the chip — it must NOT navigate
  // on its own. Only "Continue" (or "Skip") moves on, so a visitor can
  // look at their choice or read the other options first instead of being
  // bounced to the next page on tap.
  function choose(id) {
